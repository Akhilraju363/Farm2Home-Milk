...
// Kept off CustomerServiceApplication itself so @WebMvcTest slices (which include the
...
@EntityScan(basePackages = "com.farm2home.customer")
@EnableJpaRepositories(basePackages = {"com.farm2home.customer", "com.farm2home.common.core.audit"})
