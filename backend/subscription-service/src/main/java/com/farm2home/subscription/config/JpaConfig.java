...
// Kept off SubscriptionServiceApplication itself so @WebMvcTest slices (which include the
...
@EntityScan(basePackages = "com.farm2home.subscription")
@EnableJpaRepositories(basePackages = {"com.farm2home.subscription", "com.farm2home.common.core.audit"})
