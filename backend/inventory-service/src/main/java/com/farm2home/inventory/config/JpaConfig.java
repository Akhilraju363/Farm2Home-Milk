...
// Kept off InventoryServiceApplication itself so @WebMvcTest slices (which include the
...
@EntityScan(basePackages = "com.farm2home.inventory")
@EnableJpaRepositories(basePackages = {"com.farm2home.inventory", "com.farm2home.common.core.audit"})
