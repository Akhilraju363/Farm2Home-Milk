...
public class AuthController {
    ...
    public ResponseEntity<Map<String, String>> register(@Valid @RequestBody RegisterRequest request) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(Map.of("message", "Registration successful. Please verify your mobile number with the OTP sent."));
    }
    ...
    public ResponseEntity<Map<String, String>> sendOtp(@Valid @RequestBody OtpRequest request) {
        ...
        return ResponseEntity.ok(Map.of("message", "OTP sent successfully to " + request.getMobile()));
    }
