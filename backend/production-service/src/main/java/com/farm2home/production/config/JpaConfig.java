...
// Kept off ProductionServiceApplication itself so @WebMvcTest slices (which include the
...
@EntityScan(basePackages = "com.farm2home.production")
@EnableJpaRepositories(basePackages = {"com.farm2home.production", "com.farm2home.common.core.audit"})
